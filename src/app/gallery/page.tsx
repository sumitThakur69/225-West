    ...
    <>
      <div className="container mx-auto px-4 md:px-10 lg:px-16 py-16">
        <header className="text-center mb-8 md:mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-[#1F473E] mb-3">
            Our Space
          </h1>
        ...
        <footer className="text-center mt-16 md:mt-28 pt-10 border-t border-[#1F473E]/12">
